...
OUTPUT_PPTX = ROOT / "PI-MSCL_architecture_native_shapes_compact_cells_20260818.pptx"
OUTPUT_PPTX_UNGROUPED = ROOT / "PI-MSCL_architecture_native_shapes_fully_ungrouped_compact_cells_20260818.pptx"
...
def apply_line(shape, element: ET.Element) -> None:
    ...
    if stroke_key == "FFFFFF":
        width_px *= 0.42
    shape.line.width = Pt(max(0.10, width_px * PX_TO_PT))
    ...
    if solid_fill is not None:
        set_alpha_on_solid_fill(solid_fill, opacity_of(element))
