...
def main():
    ...
    varied_branch_shades = all(c in svg_text for c in ("#89B4DE", "#C1DBF1", "#86C18B", "#BFE0C1", "#9A82C8", "#C9B9E4"))
    checks["cnn.slanted_multicolor_grids"] = len(cnn_polygons) >= 200 and varied_branch_shades
