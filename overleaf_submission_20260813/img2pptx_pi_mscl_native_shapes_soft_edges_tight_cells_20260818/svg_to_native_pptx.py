...
OUTPUT_PPTX = ROOT / "PI-MSCL_architecture_native_shapes_soft_edges_tight_cells_20260818.pptx"
OUTPUT_PPTX_UNGROUPED = ROOT / "PI-MSCL_architecture_native_shapes_fully_ungrouped_soft_edges_tight_cells_20260818.pptx"
...
def apply_line(shape, element: ET.Element) -> None:
    ...
    if stroke_key == "FFFFFF":
        width_px *= 0.72
    shape.line.width = Pt(max(0.18, width_px * PX_TO_PT))
